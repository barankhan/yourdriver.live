...
$total_rows = $ridesObj->getCancelledByDriverRidesCount($vehicle_type);
$unattended_rides  = $ridesObj->getCancelledByDriverRides($vehicle_type,$page,$limit);
...
?>
    ...
    <h1>Driver Cancelled "<?php echo $vehicle_type; ?>"</h1>
